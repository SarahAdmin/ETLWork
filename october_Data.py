...
columnstoDelete2 = ['How satisfied were you with your Screening call? - de09e7f8-4e8c-498d-9ccb-237788b735d0',
       ...
       'How satisfied are you with the ease of the application process? - 513b2b55-b818-4f03-bf6f-e82b180c9e60',
       ...
       'How satisfied were you with the ease of the application process? - 513b2b55-b818-4f03-bf6f-e82b180c9e60', 'Candidate Selected Location',
       ...
       'Stage - Offer','Anonymized Contact ID','Survey Id','Survey Name','Survey Location Type','Posting ID','Current Stage ID']
OctDF = OctDF.drop(columnstoDelete2, axis=1)
print(OctDF.to_string())
