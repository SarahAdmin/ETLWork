...
columnsToDelete3 = ['Anonymized Contact ID', 'Posting ID','Current Stage ID',
       'Survey Id','How satisfied were you with our communication during the recruiting process? - e8c5e9ae-38de-4acb-855c-8d18039b1f5c',
       ...
       'How satisfied were you with the ease of the application process? - 513b2b55-b818-4f03-bf6f-e82b180c9e60','Stage - New lead', 'Stage - Reached out', 'Stage - Responded',
       ...
       'Stage - Offer','Survey Name','Survey Location Type','Candidate Selected Location','Commitment / Work Type']
NovDF = NovDF.drop(columnsToDelete3, axis=1)
NovRemote1 = NovDF.where(NovDF['Location'] == 'UK (Remote)')
NovRemote = NovRemote1.dropna()
print(NovRemote.to_string())
